...
uses u_Funcoes, u_dados, dlg_cancelacompra, uImportaUmaNFe;
...
begin
  ...
  frm_importanota.zqry_prodimporta.sql.Add('select codemp, codfilial, codprod, codbarprod, codfabprod, descprod, custoinfoprod, sldprod, precobaseprod, refprod from eqproduto where codemp=:empcod and codfabprod=:prodfab');
...
begin
  ...
  frm_importanota.zqry_prodimporta.Close;
  frm_importanota.zqry_prodimporta.sql.Clear;
  frm_importanota.zqry_prodimporta.sql.Add('select codemp, codfilial, codprod, codbarprod, codfabprod, descprod, custoinfoprod, sldprod, precobaseprod, refprod from eqproduto where codemp=:empcod and codbarprod=:ean');
  frm_importanota.zqry_prodimporta.ParamByName('empcod').AsInteger:=dm_Dados.codemp;
