object frm_TRANS_ALMOX: Tfrm_TRANS_ALMOX
  ...
  object lbl_ALMOX_ORIGEM: TLabel
    Left = 90
    Top = 20
    Width = 350
    Height = 16
  ...
  object Label6: TLabel
    ...
    Width = 244
    Height = 13
    Caption = 'Mova entre os campos pressionando ENTER'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'Tahoma'
  ...
  object Label7: TLabel
    ...
    Width = 162
    Height = 13
    Caption = 'Vis'#227'o do Produto no Almoxarifado'
  end
  ...
  object Label10: TLabel
    ...
    Width = 133
    Height = 13
    Caption = 'Vis'#227'o do Produto no Kardex'
  end
