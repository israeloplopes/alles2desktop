...
type
  Tfrm_DLG_ASSOCIAPRODUTO = class(TForm)
    Image1: TImage;
    lbl_BUSCA1: TLabel;
    lbl_BUSCA2: TLabel;
    lbl_BUSCA3: TLabel;
    ...
    zqry_EQPRODUTOPESOLIQPROD: TExtendedField;
    zqry_EQPRODUTOPESOBRUTPROD: TExtendedField;
    zqry_EQPRODUTOQTDMINPROD: TExtendedField;
    zqry_EQPRODUTOQTDMAXPROD: TExtendedField;
    zqry_EQPRODUTODTMPMPROD: TDateField;
    zqry_EQPRODUTOCUSTOMPMPROD: TExtendedField;
    zqry_EQPRODUTOCUSTOPEPSPROD: TExtendedField;
    zqry_EQPRODUTOCUSTOINFOPROD: TExtendedField;
    zqry_EQPRODUTOPRECOBASEPROD: TExtendedField;
    zqry_EQPRODUTOPRECOCOMISPROD: TExtendedField;
    zqry_EQPRODUTOSLDPROD: TExtendedField;
    zqry_EQPRODUTOSLDRESPROD: TExtendedField;
    zqry_EQPRODUTOSLDCONSIGPROD: TExtendedField;
    zqry_EQPRODUTOSLDLIQPROD: TExtendedField;
    zqry_EQPRODUTOATIVOPROD: TWideStringField;
    zqry_EQPRODUTODTULTCPPROD: TDateField;
    zqry_EQPRODUTOQTDULTCPPROD: TExtendedField;
    ...
    zqry_EQPRODUTOVLRDENSIDADE: TExtendedField;
    zqry_EQPRODUTOVLRCONCENT: TExtendedField;
    zqry_EQPRODUTOCOMPRIMENTO: TExtendedField;
    zqry_EQPRODUTOLARGURA: TExtendedField;
    zqry_EQPRODUTOESPESSURA: TExtendedField;
    zqry_EQPRODUTOGUIATRAFPROD: TWideStringField;
    zqry_EQPRODUTOQTDEMBALAGEM: TExtendedField;
    zqry_EQPRODUTOCODEANPROD: TWideStringField;
    zqry_EQPRODUTOCUBAGEM: TExtendedField;
    ...
    zqry_EQPRODUTOQTDHORASSERV: TExtendedField;
    ...
    zqry_EQPRODUTOFATORFSC: TExtendedField;
    ...
    zqry_EQPRODUTOMEDIAVENDA: TExtendedField;
    ...
    zqry_EQPRODUTOMULTIPLICADOR: TSingleField;
    zqry_EQPRODUTOCODBALANCA: TIntegerField;
    zqry_EQPRODUTOCODRFIDPROD: TIntegerField;
    zqry_EQPRODUTOPROD_SITRIBUTARIA_CSOSN: TWideStringField;
    zqry_EQPRODUTOSLDINDISPONIVEL: TExtendedField;
...
var
  frm_DLG_ASSOCIAPRODUTO: Tfrm_DLG_ASSOCIAPRODUTO;

implementation

{$R *.dfm}

uses uImportaUmaNFe, u_Funcoes, u_dados, dlg_cancelacompra;

procedure TFrm_DLG_ASSOCIAPRODUTO.FechaConexao;
begin
...
procedure TFrm_DLG_ASSOCIAPRODUTO.VarreProdutos;
begin
lbl_busca1.Caption:='';
lbl_busca2.Caption:='';
lbl_busca3.Caption:='';
lbl_PRODUTO.Caption:='';
gb_PRODUTO.caption:='Produto Consultado';
//
...
begin
  ...
  frm_importanota.zqry_prodimporta.ParamByName('empcod').AsInteger:=99;
...
procedure Tfrm_DLG_ASSOCIAPRODUTO.btn_FECHAClick(Sender: TObject);
begin
FechaConexao;
end;

procedure Tfrm_DLG_ASSOCIAPRODUTO.BitBtn1Click(Sender: TObject);
begin
  zqry_eqproduto.Close;
  btn_ASSOCIARPRODUTO.Visible:=false;
  close;
...
procedure Tfrm_DLG_ASSOCIAPRODUTO.btn_ASSOCIARPRODUTOClick(Sender: TObject);
begin
  EXECUTASGINICONSP;
  zqry_eqproduto.close;
  ...
  zqry_eqproduto.ParamByName('empcod').AsInteger:=99;
...
procedure Tfrm_DLG_ASSOCIAPRODUTO.btn_BUSCAPRODUTOClick(Sender: TObject);
begin
...
procedure Tfrm_DLG_ASSOCIAPRODUTO.DBGrid1CellClick(Column: TColumn);
begin
cod_prod_escolhido:=zqry_EQPRODUTOCODPROD.AsInteger;
btn_ASSOCIARPRODUTO.Visible:=true;
end;

procedure Tfrm_DLG_ASSOCIAPRODUTO.FormShow(Sender: TObject);
begin
VarreProdutos;
end;

procedure Tfrm_DLG_ASSOCIAPRODUTO.rg_PRODUTOSClick(Sender: TObject);
begin
...
procedure Tfrm_DLG_ASSOCIAPRODUTO.sp_BUSCAClick(Sender: TObject);
begin
