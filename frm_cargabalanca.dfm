object frm_DLG_CARGABALANCA: Tfrm_DLG_CARGABALANCA
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Carga em Balan'#231'a'
  ClientHeight = 451
  ClientWidth = 634
  Color = clBtnFace
  ...
  object btn_GERARARQUIVO: TBitBtn
    Left = 8
    Top = 388
    Width = 50
    Height = 55
  ...
  object ACBrCargaBal1: TACBrCargaBal
    Modelo = modToledoMGV6
    Left = 256
    Top = 400
  end
  object zqry_PRODBALANCA: TZQuery
    Connection = dm_DADOS.Conecta
    SQL.Strings = (
      
        'select codemp, codfilial, codprod, descprod, codunid, precobasep' +
        'rod from eqproduto')
    Params = <>
    Left = 408
    Top = 376
    object zqry_PRODBALANCACODEMP: TIntegerField
      FieldName = 'CODEMP'
      Required = True
    end
    object zqry_PRODBALANCACODFILIAL: TSmallintField
      FieldName = 'CODFILIAL'
      Required = True
    end
    object zqry_PRODBALANCACODPROD: TIntegerField
      FieldName = 'CODPROD'
      Required = True
    end
    object zqry_PRODBALANCADESCPROD: TWideStringField
      FieldName = 'DESCPROD'
      Required = True
      Size = 100
    end
    object zqry_PRODBALANCACODUNID: TWideStringField
      FieldName = 'CODUNID'
      Required = True
    end
    object zqry_PRODBALANCAPRECOBASEPROD: TExtendedField
      FieldName = 'PRECOBASEPROD'
      Precision = 19
    end
  end
  object zdts_PRODBALANCA: TDataSource
    DataSet = zqry_PRODBALANCA
    Left = 488
    Top = 376
  end
end
