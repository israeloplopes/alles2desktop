...
uses
  ...
  Spin, Buttons, ComCtrls, OleCtrls, SHDocVw, ACBrBase, ACBrDFe,
  ACBrUtil, ShellAPI, XMLIntf, XMLDoc, zlib, ACBrIntegrador,
   ACBrSAT, ACBrSocket, ACBrCEP, ACBrTEFD, ACBrTEFDClass, ACBrTEFDCliSiTef,
  IdGlobal, IdBaseComponent, IdComponent, IdTCPConnection, IdTCPClient,
  IdExplicitTLSClientServerBase, IdFTP, Vcl.Grids, Vcl.DBGrids, Vcl.Mask,
  ACBrBoleto, ACBrBoletoFCFortesFr, Data.DB, ACBrDANFCeFortesFrA4,
  ACBrDANFCeFortesFr, ACBrNFeDANFEClass, ACBrNFeDANFeRLClass, ACBrMail,
  ACBrPosPrinter, ACBrDFeReport, ACBrDFeDANFeReport, ACBrNFeDANFeESCPOS, ACBrNFe;
...
uses
  ...
  Frm_Status, Frm_SelecionarCertificado, Frm_ConfiguraSerial, u_fechacupom,
  u_dados, u_funcoes, rel_notas;
...
procedure TfrmACBrNFe.btn_GERARELATORIOClick(Sender: TObject);
begin
...
procedure TfrmACBrNFe.btn_GERARELATORIONFCeClick(Sender: TObject);
begin
if maskedit1.Text='' then maskedit1.Text:=datetostr(date);
if maskedit2.Text='' then maskedit2.Text:=datetostr(date);
...
procedure TfrmACBrNFe.btn_GERARELATORIONFeClick(Sender: TObject);
begin
if maskedit1.Text='' then maskedit1.Text:=datetostr(date);
if maskedit2.Text='' then maskedit2.Text:=datetostr(date);
...
procedure TfrmACBrNFe.btn_REIMPRIME_NFEClick(Sender: TObject);
var
